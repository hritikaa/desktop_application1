...
ins1=new InsData1(f);
src1=new SrcData1(f);
up1=new UpdateData1(f);
del1=new DelData1(f);
show1=new ShowData1(f);
tb.addTab("Register Accountant",ins1);
tb.addTab("Search Accountant",src1);
tb.addTab("update info",up1);
tb.addTab("delete Accountant",del1);
tb.addTab("show all data",show1);
...

{
	...
	Image i=tk.getImage("ACCOUTANT.jpg");
...
class ShowData1 extends JPanel
{
...
class UpdateData1 extends JPanel
{
JLabel u1,u2,u3,u4,u5,u6;
JTextField tx1,tx2,tx3,tx4,tx5,tx6;
JButton b1;
...

{
	...
	g.setFont(new Font("TimesRoman",Font.BOLD,90));
	g.drawString("UPDATE INFO",100,80);
}


}
class DelData1 extends JPanel
{
